...
def test_build_sync_script_embeds_apps_b64() -> None:
    ...
    script = _build_sync_script(apps_text, {}, _FAKE_HOST_SCRIPTS)
...
def test_build_sync_script_embeds_icon_entries() -> None:
    ...
    script = _build_sync_script("{}", icons, _FAKE_HOST_SCRIPTS)
...
def test_build_sync_script_embeds_all_three_ps1_scripts() -> None:
    """Regression guard: register + unregister + shim must all be
    ...
    rendered = _build_sync_script("{}", {}, scripts)
